...
eval "$EXEC" $MUSESCORE_PATH/03_hvala_ti_moj_isuse.mscx --ly-output $LILYPOND_PATH/03_hvala_ti_moj_isuse.ly --lilypond-version $LILYPOND_VERSION --custom-config --ordinal-number 3 --no-left-page $POINT_AND_CLICK
...
eval "$EXEC" $MUSESCORE_PATH/06_pred_svetim_kraljem.mscx --ly-output $LILYPOND_PATH/06_pred_svetim_kraljem.ly --lilypond-version $LILYPOND_VERSION --custom-config --ordinal-number 6 --left-page $POINT_AND_CLICK
...
eval "$EXEC" $MUSESCORE_PATH/09_samo_je_u_bogu_mir.mscx --ly-output $LILYPOND_PATH/09_samo_je_u_bogu_mir.ly --lilypond-version $LILYPOND_VERSION --custom-config --ordinal-number 9 --left-page $POINT_AND_CLICK
eval "$EXEC" $MUSESCORE_PATH/10_ti_si_od_vjecnosti.mscx --ly-output $LILYPOND_PATH/10_ti_si_od_vjecnosti.ly --lilypond-version $LILYPOND_VERSION --custom-config --ordinal-number 10 --left-page $POINT_AND_CLICK
eval "$EXEC" $MUSESCORE_PATH/11_ti_si_moj_mir.mscx --ly-output $LILYPOND_PATH/11_ti_si_moj_mir.ly --lilypond-version $LILYPOND_VERSION --custom-config --ordinal-number 11 --left-page $POINT_AND_CLICK
