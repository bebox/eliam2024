...
eval "$EXEC" $MUSESCORE_PATH/10_ti_si_od_vjecnosti.mscx --ly-output $LILYPOND_PATH/10_ti_si_od_vjecnosti.ly --lilypond-version $LILYPOND_VERSION --custom-config --ordinal-number 10 --left-page --set-stanza $POINT_AND_CLICK
